...
@DisplayName("Надстройка над чтением из файла и по ссылке, выбирающая тип самостоятельно.")
public class LogReaderTest {
    ...
    void readFile() {
        // given
        Reader reader = LogReader.from(PATH);
    ...
    void readIncorrectPath() {
        // given
        Reader reader = LogReader.from(INCORRECT_PATH);

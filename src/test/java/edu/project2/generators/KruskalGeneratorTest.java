...
public class KruskalGeneratorTest {
    @Test
    @DisplayName("Генерация с помощью алгоритма Крускаля.")
    void kruskalGeneratorTest() {
        // given
        KruskalGenerator generator = new KruskalGenerator(1);

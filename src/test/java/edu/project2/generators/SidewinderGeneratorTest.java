...
public class SidewinderGeneratorTest {
    @Test
    @DisplayName("Генерация методом Sidewinder.")
    void sidewinderGeneratorTest() {
        // given
        SidewinderGenerator generator = new SidewinderGenerator(1);
        ...
        assertThat(maze.getGrid()).isEqualTo(new Cell[][] {{
            ...
            new Cell(3, 6, PASSAGE),
            new Cell(3, 7, PASSAGE),
            new Cell(3, 8, PASSAGE),
